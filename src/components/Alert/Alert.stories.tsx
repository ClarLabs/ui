...
export const LongMessage: Story = {
	args: {
		...
		message:
			'This is a longer alert message that demonstrates how the component handles multi-line content. It contains more detailed information that might span across multiple lines to provide comprehensive context to the user.',
		dismissible: true
	}
}
